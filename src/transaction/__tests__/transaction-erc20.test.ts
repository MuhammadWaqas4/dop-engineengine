...
describe('Transaction/ERC20', function test() {
  ...
  it('Should generate validated inputs for transaction batch', async () => {
    ...
    await expect(
      ...
      'DOP private token balance too low for 0x000925cdf66ddf5b88016df1fe915e68eff8f192',
    );
    ...
    await expect(
      ...
      'DOP private token balance too low for 0x5fbdb2315678afecb367f032d93f642f64180aa3',
    );
    ...
    await expect(
      ...
      'DOP private token balance too low for 0x00000000000000000000000000000000000000ff',
    );
  });
